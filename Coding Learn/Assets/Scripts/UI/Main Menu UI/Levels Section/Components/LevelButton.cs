...
namespace Scripts
{
    public class LevelButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
    {
        ...
        [Space]
        [SerializeField] private float pointerEnterButtonAddedScale = 0.5f;
        [Space]
        [SerializeField] private Color buttonNormalColor;
        [SerializeField] private Color buttonSelectedColor;
        [Space]
        [SerializeField] private LevelDescriptionView levelDescriptionViewPrefab;
        [SerializeField] private Transform levelDescriptionViewContainer;
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            if (buttonComponent.interactable)
            {
                ...
                levelDescriptionView.SetDescriptionText(levelDescription);
