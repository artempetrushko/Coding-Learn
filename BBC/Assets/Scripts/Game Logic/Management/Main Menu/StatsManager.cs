...
namespace Scripts
{
    public class StatsManager : MonoBehaviour
    {
        ...
        {
            var totalChallengesCount = ContentManager.TaskChallenges[levelNumber - 1].Sum(x => x.Length);
        ...
        private List<TaskStatsData> GetDetailedTasksStats(int levelNumber)
        {
            ...
            {
                taskStatsDatas.Add(new TaskStatsData(ContentManager.TaskInfos[levelNumber - 1][i - 1].Title, 
                                                     GetCompletedChallengesCount(levelNumber, i), 
                                                     ContentManager.TaskChallenges[levelNumber - 1][i - 1].Length));
            }*/
