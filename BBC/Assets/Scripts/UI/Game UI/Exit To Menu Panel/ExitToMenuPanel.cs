...
namespace Scripts
{
    public class ExitToMenuPanel : MonoBehaviour
    {
        [SerializeField] 
        ...
        {
            yield return StartCoroutine(PlayAnimation_COR(gameObject, "HideExitToMenuPanel"));
            isPressed = false;
        }
        ...
        private void Update()
        {
            ...
            {
                GetComponent<Animator>().Play("AppearExitToMenuPanel");
                isPressed = true;
            }
        }
    }
