...
namespace Scripts
{
    public class LevelsManager : MonoBehaviour
    {
        ...
        public void SetLevelsSectionStartState() => levelsSectionView.CallChooseLevelButtonEvent(selectedLevelNumber);
        ...
        private void Start()
        {
            ...
            levelsSectionView.CreateChooseLevelButtons(10, SaveManager.SaveData.LastAvailableLevelNumber, ShowLevelInfo);
