...
namespace RoslynCSharp
{
    ...
    public class ScriptDomain : IDisposable
    {
        ...
        //public ScriptAssembly RegisterAssembly(Assembly assembly, string assemblyPath, byte[] assemblyImage, ScriptSecurityMode securityMode, bool isRuntimeCompiled, CompilationResult compileResult = null)
        //{
        //    // Check for error
        //    if (assembly == null)
        //        return null;
